...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/company/aetherzenith',
      icon: (
        <svg
          className="h-5 w-5"
          fill="currentColor"
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/aetherzenith',
      icon: (
        <svg
          className="h-5 w-5"
          fill="currentColor"
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/aetherzenith',
      icon: (
        <svg
          className="h-5 w-5"
          fill="currentColor"
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-6">{t('footer.contactUs')}</h3>
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="h-6 w-6 text-gray-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@aetherzenith.com" className="text-gray-400 hover:text-white transition-colors">
                  info@aetherzenith.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Aether Zenith Technologies Ltd. {t('footer.allRightsReserved')}
            </p>
